"""Installer for the collective_blog package."""
...
setup(
    ...
    version="1.0.0a1",
    description="collective.blog configuration package.",
    ...
    project_urls={
        "PyPI": "https://pypi.python.org/pypi/collective_blog",
    ...
    target = plone
    [console_scripts]
    update_locale = collective_blog.locales.update:update_locale
    """,
)
