...
STACK_NAME=collective-blog-example-com
...
build-acceptance-servers: ## Build Acceptance Servers
	...
	@docker build backend -t collective/collective.blog-backend:acceptance -f backend/Dockerfile.acceptance
	@echo "Build acceptance frontend"
	@docker build frontend -t collective/collective.blog-frontend:acceptance -f frontend/Dockerfile
